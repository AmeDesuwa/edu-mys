...
# Map dimensions: 31 wide x 23 tall (smaller for better hand-designed layouts)
const MAP_WIDTH = 31
const MAP_HEIGHT = 23

# Map 1: Simple maze - Clear linear progression
const MAP_1 = [
	"###############################",
	"#S....#.....#.....#.....#.....#",
	"#.###.#.###.#.###.#.###.#.###.#",
...
# Map 2: Branching maze - Multiple paths with dead ends
const MAP_2 = [
	"###############################",
	"#S..#.........#...............#",
	"###.#.#######.#.#############.#",
...
# Map 3: Complex maze - Winding paths and chambers
const MAP_3 = [
	"###############################",
	"#S............................#",
	"#.######################.####.#",
