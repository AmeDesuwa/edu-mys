...
signal collected(answer_text: String, question_index: int, is_correct: bool)
...
func _collect():
	# Emit signal with our data
	emit_signal("collected", answer_text, question_index, is_correct)
